...
if(isset($_REQUEST['sub_code']) && $_REQUEST['sub_code'] != null) {
	...
	if(isset($_REQUEST['sub_url']) && $_REQUEST['sub_url'] != null) {
		...
		$sub_url = "https://secure.motherjones.com/fnx/?action=SUBSCRIPTION&pub_code=MJM&term_pub=MJM&b_country=United+States&list_source=S75NLP1";
	...
	if(isset($_REQUEST['sub_image']) && $_REQUEST['sub_image'] != null) {
		...
		$sub_image = "https://cdn.maropost.com/pro/uploads/account_585/159842/2017_NL_600x200.jpg";
	...
	if(isset($_REQUEST['sub_text']) && $_REQUEST['sub_text'] != null) {
		...
		$sub_text = "Subscribe to Mother Jones";
		//$sub_text = "Mother Jones Store";
	}
	
	$small_sub_ad = "<a href=\"$sub_url\"><img id=\"sub_ad\" src=\"$sub_image\" style=\"max-width: 540px;width:540px;border: none !important;\" width=\"540\" alt=\"$sub_text\" border=\"0\" /></a>";
}
